...
def generate_launch_description():
    params1_file = get_package_share_directory("astra_camera") + "/params/multi_camera/dcw1_params.yaml"
    params2_file = get_package_share_directory("astra_camera") + "/params/multi_camera/dcw2_params.yaml"
    camera_suffix1 = '1'
    camera_suffix2 = '2'
